...
local Tabs = {
        Main0=Window:AddTab({ Title="Key" }),
        Main1=Window:AddTab({ Title="Blox Fruit" }),
        Main2=Window:AddTab({ Title="99 đêm" }),
        Main3=Window:AddTab({ Title="Trồng cây"})
}
    Tabs.Main0:AddButton({
    Title = "Key",
    Description = "Vui lòng nhấn vào để sao chép!",
    Callback = function()
        setclipboard("FREE_PREMIUM_AKLP2")
    end
})
